...
После регистрации и авторизации пользователь получает access JWToken, используя который, он получает доступ к остальным сервисам.
Пользователь может выйти из своей учетной записи, в этом случае его JWToken деактивируется.
